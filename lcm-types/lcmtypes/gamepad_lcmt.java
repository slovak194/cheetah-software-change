...
public final class gamepad_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0xa857d7961e448703L;
    ...
    {
        outs.writeInt(this.up); 
 
        outs.writeInt(this.down); 
