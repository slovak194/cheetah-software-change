...
#ifndef __controller2webots_t_hpp__
#define __controller2webots_t_hpp__

#include <lcm/lcm_coretypes.h>



class controller2webots_t
{
    public:
        float      q_des_abad[4];
...
int controller2webots_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int controller2webots_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int controller2webots_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t controller2webots_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* controller2webots_t::getTypeName()
{
    return "controller2webots_t";
}

int controller2webots_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int controller2webots_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int controller2webots_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t controller2webots_t::_computeHash(const __lcm_hash_ptr *)
{
