...
int spi_torque_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int spi_torque_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int spi_torque_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t spi_torque_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* spi_torque_t::getTypeName()
{
    return "spi_torque_t";
}

int spi_torque_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int spi_torque_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int spi_torque_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t spi_torque_t::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xa847131dd865b527LL;
